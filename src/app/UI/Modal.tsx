const Modal = () => {
  return (
    <div className="flex flex-col  border border-gray-300 rounded-2xl p-4 md:p-8 lg:p-12 gap-6 bg-white dark:bg-gray-900 px-30">
      <div>
        <h2 className="text-xl py-4 md:text-2xl font-bold dark:text-white">
          Pages
        </h2>
