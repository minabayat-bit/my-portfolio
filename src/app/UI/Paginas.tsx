...
const Pages = () => {
  return (
    ...
    >
      ...
      <div className=" dark:bg-gray-900 bg-gray-50 text-gray-800 dark:text-white pt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-center gap-3 bg-gray-200 dark:bg-gray-800 p-4 rounded shadow">
            <svg
              ...
              className="shrink-0 h-5 w-5 fill-black/75 dark:fill-slate-200"
            >
              <g>
                <path
          ...
          <div className="flex items-center gap-3 bg-gray-200 dark:bg-gray-800 p-4 rounded shadow">
            <img className="w-6.5" src={"/vite.png"} alt="" />
            <span>Vite</span>
          </div>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-center gap-3 bg-gray-200 dark:bg-gray-800 p-4 rounded shadow">
            <img className="w-6.5" src={"/js.svg"} alt="" />
          ...
          <div className="flex items-center gap-3 bg-gray-200 dark:bg-gray-800 p-4 rounded shadow">
            <svg
              ...
              viewBox="0 0 512 512"
              fill="#cf649a"
              className="ionicon shrink-0 h-5 w-5"
            >
